...
from models.MMDT.encoder.encoder_layer import DeformableTransformerEncoderLayer
from models.MMDT.decoder.decoder_layer import DeformableTransformerDecoderLayer
...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, refpoint_embed, pos_embeds, tgt, attn_mask=None, return_interm_indices=None):
        ...
        if self.two_stage_type == 'standard':  # 'standard'
